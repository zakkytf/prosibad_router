...
<button class="btn btn-outline my-2 my-sm-0" ><a href="<?php echo base_url().'index.php/login/logout'?>">Log out Admin</a></button>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <h2>Portal sosialisasi</h2><hr/>
      <form action="<?php echo base_url().'index.php/post_sls/simpan_post'?>" method="post" enctype="multipart/form-data">
              <input type="text" name="judul" class="form-control" placeholder="Judul sosialisasi" required/><br/>
              <textarea id="ckeditor" name="sls" class="form-control" required></textarea><br/>
              <input type="file" name="filefoto" required><br>
              <button class="btn btn-primary btn-lg" type="submit">Post sosialisasi</button>
            </form>
    </div>
