    ...
    ?>
     ...
     <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p class="card-text"><?php echo limit_words($isi,90000);?><a href="<?php echo base_url().'index.php/post_sls/view/'.$id;?>"></a></p>
              <div>
         <a href="<?php echo base_url().'index.php/post_sls/view/'.$id;?>" class="btn btn-primary">Read More →</a>
            </div>
