      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <div class="nav-link">
              <?php echo anchor('page','<div class="customcolor"> Beranda </div>'); ?>
            </div>
             <li class="nav-item">
            <div class="nav-link">
  ...
  <div class="container">
    <?php
      ...
      foreach ($data->result_array() as $i) :
        $id=$i['pelpro_id'];
        $judul=$i['pelpro_judul'];
        $image=$i['pelpro_image'];
        $isi=$i['pelpro_isi'];
    ?>
     ...
     <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p class="card-text"><?php echo limit_words($isi,90000);?><a href="<?php echo base_url().'index.php/post_pelpro/view/'.$id;?>"></a></p>
              <div>
         <a href="<?php echo base_url().'index.php/post_pelpro/view/'.$id;?>" class="btn btn-primary">Read More →</a>
            </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <?php echo anchor('Page','<div> Siap Tanggap </div>'); ?>
                    </li>
                    
                    <li>
                  <?php echo anchor('Korporat/viewsosialcorp','<div> Sosialisasi </div>'); ?>
                ...
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                <?php echo anchor('Korporat/viewprogramcorp','<div> Program </div>'); ?>
                    </li>
                    <li>
                      <?php echo anchor('Korporat/viewpelaksanaancorp','<div> Pelaksanaan </div>'); ?>
                    </li>
                  </ul>
                </div>
              </div>
